...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 bg-[#F8F9FA] flex items-center justify-center px-16">
        <div className="w-full max-w-[320px]">
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full h-[44px] bg-[#4A6CF7] hover:bg-[#3B5CF0] text-white text-[14px] font-medium rounded-[6px] transition-colors duration-200 mt-8"
            >
              Sign up
            </button>
          </form>
      ...
      <div className="w-[35%] bg-[#4A6CF7] flex flex-col items-center justify-center text-white px-12">
        <div className="text-center">
          {/* Logo */}
          <div className="w-[60px] h-[60px] bg-white rounded-[12px] flex items-center justify-center mx-auto mb-6">
            <div className="text-[#4A6CF7] text-[28px] font-bold">K</div>
          </div>
